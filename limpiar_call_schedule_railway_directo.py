#!/usr/bin/env python3
"""
Script de limpieza para call_schedule en Railway usando conexión directa
...
def get_railway_connection():
    """Obtiene conexión directa usando variables de entorno de Railway"""
    try:
        ...
        logger.error(f"Error conectando a Railway MySQL: {e}")
        return None
...
def limpiar_call_schedule():
    ...
    if not conn:
        logger.error("No se pudo conectar a la BD de Railway")
        return False
    ...
    try:
        ...
        print("4. Limpiando programaciones huerfanas...")
        cursor.execute("""
        ...
        print("5. Verificando leads con multiples programaciones pendientes...")
        cursor.execute("""
        ...
        if multiples_pendientes:
            print("   Leads con multiples programaciones pendientes:")
            ...
            print("   Manteniendo solo la programacion mas reciente por lead...")
            cursor.execute("""
                DELETE cs1 FROM call_schedule cs1
                INNER JOIN (
            ...
            print("   No se encontraron leads con multiples programaciones pendientes")
...
def verificar_leads_problematicos():
    ...
    try:
        ...
        print(f"Estado de los {len(problematic_leads)} leads problematicos:")
        ...
        print()
        print("Los warnings deberian reducirse significativamente despues de esta limpieza.")
...
if __name__ == "__main__":
    print("LIMPIEZA DE CALL_SCHEDULE EN RAILWAY (CONEXION DIRECTA)")
    print("=" * 60)
    ...
    if limpiar_call_schedule():
        ...
        print()
        print("=" * 60)
        print("[EXITO] Limpieza completada exitosamente en Railway")
    else:
        print()
        print("[ERROR] La limpieza fallo")