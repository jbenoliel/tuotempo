...
def main():
    # URL y headers según el JSON proporcionado
    url = "https://app.tuotempo.com/api/v3/tt_portal_adeslas/availabilities"
    
    # Parámetros de la consulta
    # Convertir la fecha ISO a formato DD/MM/YYYY
    # La fecha ISO "2025-06-25T08:45:14.167Z" corresponde a "25/06/2025" en formato DD/MM/YYYY
    params = {
        "lang": "es",
    ...
    print(f"Ejecutando petición con fecha en formato ISO: {params['start_date']}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            with open('curl_iso_response.json', 'w', encoding='utf-8') as f:
                json.dump(json_response, f, indent=2, ensure_ascii=False)
            
            print(f"Código de estado: {response.status_code}")
            print(f"Respuesta completa guardada en 'curl_iso_response.json'\n")
